...
class NameCameraForm(forms.ModelForm):
    ...
    class Meta:
        model = VideoCamera
        fields = ('name', 'mimetype', 'width', 'use_websocket', 'echo_cancellation', 'compress_video', 'adjust_pitch', 'animate_video', 'short_mode', 'embed_logo', 'live', 'recording', 'upload', 'livestream', 'title', 'description', 'tags')
